...
Every entry on the [Releases page](../../releases) matches a version published to npm. A release is
created automatically when a publish completes — never by hand, and never for a dry run. If a version
is not listed there, it was not published.
